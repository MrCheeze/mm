...
/* 023094 0x80096938 14850003 */ bne	$a0, $a1, .L_80096948
...
/* 023099 0x8009694C 1020000D */ beqz	$at, .L_80096984
/* 023100 0x80096950 24E8FFFF */ addiu	$t0, $a3, -1
/* 023101 0x80096954 00E03025 */ move	$a2, $a3
/* 023102 0x80096958 10E00016 */ beqz	$a3, .L_800969B4
/* 023103 0x8009695C 24E7FFFF */ addiu	$a3, $a3, -1
.L_80096960:
/* 023104 0x80096960 906E0000 */ lbu	$t6, 0X0($v1)
/* 023105 0x80096964 00E03025 */ move	$a2, $a3
/* 023106 0x80096968 24420001 */ addiu	$v0, $v0, 1
/* 023107 0x8009696C 24630001 */ addiu	$v1, $v1, 1
/* 023108 0x80096970 A04EFFFF */ sb	$t6, -0X1($v0)
/* 023109 0x80096974 14E0FFFA */ bnez	$a3, .L_80096960
/* 023110 0x80096978 24E7FFFF */ addiu	$a3, $a3, -1
/* 023111 0x8009697C 1000000E */ b	.L_800969B8
...
/* 023116 0x80096990 10E00008 */ beqz	$a3, .L_800969B4
/* 023117 0x80096994 24E7FFFF */ addiu	$a3, $a3, -1
.L_80096998:
/* 023118 0x80096998 906F0000 */ lbu	$t7, 0X0($v1)
/* 023119 0x8009699C 00E03025 */ move	$a2, $a3
/* 023120 0x800969A0 2442FFFF */ addiu	$v0, $v0, -1
/* 023121 0x800969A4 2463FFFF */ addiu	$v1, $v1, -1
/* 023122 0x800969A8 A04F0001 */ sb	$t7, 0X1($v0)
/* 023123 0x800969AC 14E0FFFA */ bnez	$a3, .L_80096998
/* 023124 0x800969B0 24E7FFFF */ addiu	$a3, $a3, -1
.L_800969B4:
