...
/* 023078 0x800968F8 50400008 */ beqzl	$v0, .L_8009691C
/* 023079 0x800968FC A0600000 */ sb	$zero, 0X0($v1)
/* 023080 0x80096900 A0620000 */ sb	$v0, 0X0($v1)
.L_80096904:
/* 023081 0x80096904 90A20001 */ lbu	$v0, 0X1($a1)
/* 023082 0x80096908 24630001 */ addiu	$v1, $v1, 1
/* 023083 0x8009690C 24A50001 */ addiu	$a1, $a1, 1
/* 023084 0x80096910 5440FFFC */ bnezl	$v0, .L_80096904
