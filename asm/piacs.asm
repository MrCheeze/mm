...
/* 012364 0x8008C190 27BDFFE8 */ addiu	$sp, $sp, -24
/* 012365 0x8008C194 AFBF0014 */ sw	$ra, 0X14($sp)
/* 012366 0x8008C198 240E0001 */ li	$t6, 1
...
/* 012374 0x8008C1B8 24060001 */ li	$a2, 1
...
/* 012381 0x8008C1D4 27BD0018 */ addiu	$sp, $sp, 24
...
/* 012386 0x8008C1E8 27BDFFE0 */ addiu	$sp, $sp, -32
/* 012387 0x8008C1EC AFBF0014 */ sw	$ra, 0X14($sp)
/* 012388 0x8008C1F0 15C00003 */ bnez	$t6, .L_8008C200
...
/* 012409 0x8008C244 27BD0018 */ addiu	$sp, $sp, 24
