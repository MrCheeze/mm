...
/* 023050 0x80096888 10C00006 */ beqz	$a2, .L_800968A4
/* 023051 0x8009688C 24C6FFFF */ addiu	$a2, $a2, -1
.L_80096890:
/* 023052 0x80096890 00C01825 */ move	$v1, $a2
/* 023053 0x80096894 A0450000 */ sb	$a1, 0X0($v0)
/* 023054 0x80096898 24420001 */ addiu	$v0, $v0, 1
/* 023055 0x8009689C 14C0FFFC */ bnez	$a2, .L_80096890
/* 023056 0x800968A0 24C6FFFF */ addiu	$a2, $a2, -1
.L_800968A4:
