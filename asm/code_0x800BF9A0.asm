...
/* 026552 0x800BF9A0 27BDFFD0 */ addiu	$sp, $sp, -48
...
/* 026560 0x800BF9C0 2404FFFE */ li	$a0, -2
/* 026561 0x800BF9C4 0C0210E7 */ jal	FaultDrawer_SetCharPad
/* 026562 0x800BF9C8 00002825 */ move	$a1, $zero
/* 026563 0x800BF9CC 3C12801B */ lui	$s2, %hi(D_801B4610)
/* 026564 0x800BF9D0 26524610 */ addiu	$s2, $s2, %lo(D_801B4610)
...
/* 026573 0x800BF9F4 3C10801B */ lui	$s0, %hi(actorOverlayTable)
/* 026574 0x800BF9F8 2610EFD0 */ addiu	$s0, $s0, %lo(actorOverlayTable)
/* 026575 0x800BF9FC 18400017 */ blez	$v0, .L_800BFA5C
...
/* 026585 0x800BFA24 10C00009 */ beqz	$a2, .L_800BFA4C
...
/* 026593 0x800BFA44 3C02801B */ lui	$v0, %hi(D_801B4610)
/* 026594 0x800BFA48 8C424610 */ lw	$v0, %lo(D_801B4610)($v0)
.L_800BFA4C:
/* 026595 0x800BFA4C 26310001 */ addiu	$s1, $s1, 1
/* 026596 0x800BFA50 0222082A */ slt	$at, $s1, $v0
/* 026597 0x800BFA54 1420FFEF */ bnez	$at, .L_800BFA14
/* 026598 0x800BFA58 26100020 */ addiu	$s0, $s0, 32
.L_800BFA5C:
...
/* 026605 0x800BFA74 27BD0030 */ addiu	$sp, $sp, 48

glabel func_800BFA78
/* 026606 0x800BFA78 AFA50004 */ sw	$a1, 0X4($sp)
/* 026607 0x800BFA7C 3C05801B */ lui	$a1, %hi(D_801B4610)
/* 026608 0x800BFA80 8CA54610 */ lw	$a1, %lo(D_801B4610)($a1)
/* 026609 0x800BFA84 3C02801B */ lui	$v0, %hi(actorOverlayTable)
/* 026610 0x800BFA88 2442EFD0 */ addiu	$v0, $v0, %lo(actorOverlayTable)
/* 026611 0x800BFA8C 18A00013 */ blez	$a1, .L_800BFADC
...
/* 026618 0x800BFAA8 11000008 */ beqz	$t0, .L_800BFACC
/* 026619 0x800BFAAC 01C73023 */ subu	$a2, $t6, $a3
/* 026620 0x800BFAB0 14200006 */ bnez	$at, .L_800BFACC
/* 026621 0x800BFAB4 01067821 */ addu	$t7, $t0, $a2
/* 026622 0x800BFAB8 008F082B */ sltu	$at, $a0, $t7
/* 026623 0x800BFABC 50200004 */ beqzl	$at, .L_800BFAD0
/* 026624 0x800BFAC0 24630001 */ addiu	$v1, $v1, 1
/* 026625 0x800BFAC4 03E00008 */ jr	$ra
/* 026626 0x800BFAC8 00891021 */ addu	$v0, $a0, $t1
.L_800BFACC:
/* 026627 0x800BFACC 24630001 */ addiu	$v1, $v1, 1
.L_800BFAD0:
/* 026628 0x800BFAD0 0065082A */ slt	$at, $v1, $a1
/* 026629 0x800BFAD4 1420FFEF */ bnez	$at, .L_800BFA94
/* 026630 0x800BFAD8 24420020 */ addiu	$v0, $v0, 32
.L_800BFADC:
/* 026631 0x800BFADC 00001025 */ move	$v0, $zero
/* 026632 0x800BFAE0 03E00008 */ jr	$ra
/* 026633 0x800BFAE4 00000000 */ nop

glabel func_800BFAE8
/* 026634 0x800BFAE8 27BDFFE8 */ addiu	$sp, $sp, -24
/* 026635 0x800BFAEC AFBF0014 */ sw	$ra, 0X14($sp)
/* 026636 0x800BFAF0 240E02B2 */ li	$t6, 690
/* 026637 0x800BFAF4 3C01801B */ lui	$at, %hi(D_801B4610)
/* 026638 0x800BFAF8 3C04801F */ lui	$a0, %hi(D_801ED930)
/* 026639 0x800BFAFC 3C05800C */ lui	$a1, %hi(func_800BF9A0)
/* 026640 0x800BFB00 AC2E4610 */ sw	$t6, %lo(D_801B4610)($at)
/* 026641 0x800BFB04 24A5F9A0 */ addiu	$a1, $a1, %lo(func_800BF9A0)
...
/* 026647 0x800BFB1C 3C05800C */ lui	$a1, %hi(func_800BFA78)
/* 026648 0x800BFB20 24A5FA78 */ addiu	$a1, $a1, %lo(func_800BFA78)
...
/* 026653 0x800BFB34 27BD0018 */ addiu	$sp, $sp, 24
/* 026654 0x800BFB38 03E00008 */ jr	$ra
/* 026655 0x800BFB3C 00000000 */ nop

glabel func_800BFB40
/* 026656 0x800BFB40 27BDFFE8 */ addiu	$sp, $sp, -24
...
/* 026664 0x800BFB60 3C01801B */ lui	$at, %hi(D_801B4610)
/* 026665 0x800BFB64 AC204610 */ sw	$zero, %lo(D_801B4610)($at)
/* 026666 0x800BFB68 8FBF0014 */ lw	$ra, 0X14($sp)
/* 026667 0x800BFB6C 27BD0018 */ addiu	$sp, $sp, 24
