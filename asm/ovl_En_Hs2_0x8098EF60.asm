...
glabel EnHs2_Init
/* 000000 0x8098EF60 27BDFFE8 */ addiu	$sp, $sp, -24
...
/* 000008 0x8098EF80 3C0E8099 */ lui	$t6, %hi(func_8098EFAC)
/* 000009 0x8098EF84 25CEEFAC */ addiu	$t6, $t6, %lo(func_8098EFAC)
/* 000010 0x8098EF88 ADEE0394 */ sw	$t6, 0X394($t7)
/* 000011 0x8098EF8C 8FBF0014 */ lw	$ra, 0X14($sp)
/* 000012 0x8098EF90 27BD0018 */ addiu	$sp, $sp, 24
...
glabel EnHs2_Update
/* 000023 0x8098EFBC 27BDFFE8 */ addiu	$sp, $sp, -24
...
/* 000029 0x8098EFD4 27BD0018 */ addiu	$sp, $sp, 24
