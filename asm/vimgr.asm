...
/* 021648 0x800952A0 27BDFFD0 */ addiu	$sp, $sp, -48
...
/* 021655 0x800952BC 55C00054 */ bnezl	$t6, .L_80095410
...
/* 021666 0x800952E8 24060005 */ li	$a2, 5
...
/* 021671 0x800952FC 240F000D */ li	$t7, 13
/* 021672 0x80095300 2418000E */ li	$t8, 14
...
/* 021682 0x80095328 24040007 */ li	$a0, 7
...
/* 021688 0x80095340 24040003 */ li	$a0, 3
/* 021689 0x80095344 2419FFFF */ li	$t9, -1
...
/* 021696 0x80095360 10200003 */ beqz	$at, .L_80095370
...
/* 021708 0x80095390 24090001 */ li	$t1, 1
...
/* 021733 0x800953F4 2401FFFF */ li	$at, -1
/* 021734 0x800953F8 00002025 */ move	$a0, $zero
/* 021735 0x800953FC 51810004 */ beql	$t4, $at, .L_80095410
...
/* 021741 0x80095414 27BD0030 */ addiu	$sp, $sp, 48
/* 021742 0x80095418 03E00008 */ jr	$ra
/* 021743 0x8009541C 00000000 */ nop

glabel viMgrMain
/* 021744 0x80095420 27BDFFB0 */ addiu	$sp, $sp, -80
...
/* 021759 0x8009545C 2416000E */ li	$s6, 14
/* 021760 0x80095460 14600004 */ bnez	$v1, .L_80095474
/* 021761 0x80095464 A423F8A0 */ sh	$v1, %lo(vimgrRetrace)($at)
/* 021762 0x80095468 24030001 */ li	$v1, 1
...
/* 021790 0x800954D8 2463FFFF */ addiu	$v1, $v1, -1
/* 021791 0x800954DC 306FFFFF */ andi	$t7, $v1, 0XFFFF
/* 021792 0x800954E0 15E0000E */ bnez	$t7, .L_8009551C
...
/* 021799 0x800954FC 53000005 */ beqzl	$t8, .L_80095514
...
/* 021809 0x80095524 27280001 */ addiu	$t0, $t9, 1
...
/* 021816 0x80095540 240A0000 */ li	$t2, 0
...
/* 021842 0x800955A8 27BD0050 */ addiu	$sp, $sp, 80
