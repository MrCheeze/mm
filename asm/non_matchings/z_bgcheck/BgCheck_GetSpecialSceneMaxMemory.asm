...
.L_800C378C:
/* 030515 0x800C378C 548E0006 */ bnel	$a0, $t6, .L_800C37A8
/* 030516 0x800C3790 24630008 */ addiu	$v1, $v1, 8
/* 030517 0x800C3794 8C6F0004 */ lw	$t7, 0X4($v1)
/* 030518 0x800C3798 24020001 */ li	$v0, 1
/* 030519 0x800C379C 03E00008 */ jr	$ra
/* 030520 0x800C37A0 ACAF0000 */ sw	$t7, 0X0($a1)
/* 030521 0x800C37A4 24630008 */ addiu	$v1, $v1, 8
.L_800C37A8:
/* 030522 0x800C37A8 5462FFF8 */ bnel	$v1, $v0, .L_800C378C
