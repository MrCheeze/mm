glabel Actor_Init
/* 019884 0x800B9170 27BDFFD8 */ addiu	$sp, $sp, -40
...
/* 019903 0x800B91BC 27193F68 */ addiu	$t9, $t8, 16232
...
/* 019908 0x800B91D0 24050284 */ li	$a1, 644
/* 019909 0x800B91D4 0C02FEBA */ jal	func_800BFAE8
...
/* 019923 0x800B920C 3C01801B */ lui	$at, %hi(actorOverlayTable + 0x10)
/* 019924 0x800B9210 AC20EFE0 */ sw	$zero, %lo(actorOverlayTable + 0x10)($at)
/* 019925 0x800B9214 3C02801B */ lui	$v0, %hi(actorOverlayTable + 0x20)
/* 019926 0x800B9218 2442EFF0 */ addiu	$v0, $v0, %lo(actorOverlayTable + 0x20)
/* 019927 0x800B921C 3C01801B */ lui	$at, %hi(actorOverlayTable + 0x1E)
/* 019928 0x800B9220 8FA60020 */ lw	$a2, 0X20($sp)
/* 019929 0x800B9224 A020EFEE */ sb	$zero, %lo(actorOverlayTable + 0x1E)($at)
/* 019930 0x800B9228 A040001E */ sb	$zero, 0X1E($v0)
/* 019931 0x800B922C AC400010 */ sw	$zero, 0X10($v0)
/* 019932 0x800B9230 24420020 */ addiu	$v0, $v0, 32
/* 019933 0x800B9234 24030002 */ li	$v1, 2
/* 019934 0x800B9238 240402B2 */ li	$a0, 690
.L_800B923C:
/* 019935 0x800B923C 24630004 */ addiu	$v1, $v1, 4
...
/* 019942 0x800B9258 24420080 */ addiu	$v0, $v0, 128
/* 019943 0x800B925C AC40FF90 */ sw	$zero, -0X70($v0)
/* 019944 0x800B9260 1464FFF6 */ bne	$v1, $a0, .L_800B923C
/* 019945 0x800B9264 A040FF9E */ sb	$zero, -0X62($v0)
/* 019946 0x800B9268 8CC90000 */ lw	$t1, 0X0($a2)
/* 019947 0x800B926C 24010018 */ li	$at, 24
...
/* 019976 0x800B92E0 26040120 */ addiu	$a0, $s0, 288
...
/* 019996 0x800B9330 27BD0028 */ addiu	$sp, $sp, 40
