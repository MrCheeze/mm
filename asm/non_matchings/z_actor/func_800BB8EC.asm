...
/* 022411 0x800BB8EC 27BDFFD0 */ addiu	$sp, $sp, -48
...
/* 022460 0x800BB9B0 24150003 */ li	$s5, 3
...
/* 022467 0x800BB9CC 26100001 */ addiu	$s0, $s0, 1
/* 022468 0x800BB9D0 1615FFF9 */ bne	$s0, $s5, .L_800BB9B8
/* 022469 0x800BB9D4 26310001 */ addiu	$s1, $s1, 1
/* 022470 0x800BB9D8 3C02801F */ lui	$v0, %hi(D_801ED8B8)
/* 022471 0x800BB9DC 8C42D8B8 */ lw	$v0, %lo(D_801ED8B8)($v0)
/* 022472 0x800BB9E0 2A01000C */ slti	$at, $s0, 12
/* 022473 0x800BB9E4 1440000D */ bnez	$v0, .L_800BBA1C
/* 022474 0x800BB9E8 00000000 */ nop
/* 022475 0x800BB9EC 1020000B */ beqz	$at, .L_800BBA1C
.L_800BB9F0:
...
/* 022481 0x800BBA04 26100001 */ addiu	$s0, $s0, 1
/* 022482 0x800BBA08 2A01000C */ slti	$at, $s0, 12
/* 022483 0x800BBA0C 1420FFF8 */ bnez	$at, .L_800BB9F0
/* 022484 0x800BBA10 26310001 */ addiu	$s1, $s1, 1
/* 022485 0x800BBA14 3C02801F */ lui	$v0, %hi(D_801ED8B8)
/* 022486 0x800BBA18 8C42D8B8 */ lw	$v0, %lo(D_801ED8B8)($v0)
.L_800BBA1C:
/* 022487 0x800BBA1C 14400006 */ bnez	$v0, .L_800BBA38
...
/* 022492 0x800BBA30 10000002 */ b	.L_800BBA3C
...
/* 022513 0x800BBA84 27BD0030 */ addiu	$sp, $sp, 48
