...
/* 019176 0x80092C00 27BDFFA8 */ addiu	$sp, $sp, -88
...
/* 019182 0x80092C18 27A20038 */ addiu	$v0, $sp, 56
/* 019183 0x80092C1C 27A30058 */ addiu	$v1, $sp, 88
.L_80092C20:
/* 019184 0x80092C20 24420004 */ addiu	$v0, $v0, 4
/* 019185 0x80092C24 A050FFFD */ sb	$s0, -0X3($v0)
/* 019186 0x80092C28 A050FFFE */ sb	$s0, -0X2($v0)
/* 019187 0x80092C2C A050FFFF */ sb	$s0, -0X1($v0)
/* 019188 0x80092C30 1443FFFB */ bne	$v0, $v1, .L_80092C20
/* 019189 0x80092C34 A050FFFC */ sb	$s0, -0X4($v0)
/* 019190 0x80092C38 8FAE0058 */ lw	$t6, 0X58($sp)
/* 019191 0x80092C3C 24060400 */ li	$a2, 1024
/* 019192 0x80092C40 27A70038 */ addiu	$a3, $sp, 56
...
/* 019197 0x80092C54 14400003 */ bnez	$v0, .L_80092C64
...
/* 019203 0x80092C6C 27BD0058 */ addiu	$sp, $sp, 88
