...
/* 251136 0x8019AEC0 20AF0020 */ addi	$t7, $a1, 32
.L_8019AEC4:
...
/* 251141 0x8019AED4 20A50010 */ addi	$a1, $a1, 16
...
/* 251146 0x8019AEE8 14AFFFF6 */ bne	$a1, $t7, .L_8019AEC4
/* 251147 0x8019AEEC 20840010 */ addi	$a0, $a0, 16
