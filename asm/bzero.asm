...
glabel bzero
/* 009588 0x80089630 28A1000C */ slti	$at, $a1, 12
/* 009589 0x80089634 1420001D */ bnez	$at, .L_800896AC
/* 009590 0x80089638 00041823 */ negu	$v1, $a0
/* 009591 0x8008963C 30630003 */ andi	$v1, $v1, 0X3
/* 009592 0x80089640 10600003 */ beqz	$v1, .L_80089650
...
.L_80089650:
/* 009596 0x80089650 2401FFE0 */ li	$at, -32
/* 009597 0x80089654 00A13824 */ and	$a3, $a1, $at
/* 009598 0x80089658 10E0000C */ beqz	$a3, .L_8008968C
/* 009599 0x8008965C 00A72823 */ subu	$a1, $a1, $a3
/* 009600 0x80089660 00E43821 */ addu	$a3, $a3, $a0
.L_80089664:
/* 009601 0x80089664 24840020 */ addiu	$a0, $a0, 32
...
/* 009609 0x80089684 1487FFF7 */ bne	$a0, $a3, .L_80089664
/* 009610 0x80089688 AC80FFFC */ sw	$zero, -0X4($a0)
.L_8008968C:
/* 009611 0x8008968C 2401FFFC */ li	$at, -4
/* 009612 0x80089690 00A13824 */ and	$a3, $a1, $at
/* 009613 0x80089694 10E00005 */ beqz	$a3, .L_800896AC
/* 009614 0x80089698 00A72823 */ subu	$a1, $a1, $a3
/* 009615 0x8008969C 00E43821 */ addu	$a3, $a3, $a0
.L_800896A0:
/* 009616 0x800896A0 24840004 */ addiu	$a0, $a0, 4
/* 009617 0x800896A4 1487FFFE */ bne	$a0, $a3, .L_800896A0
/* 009618 0x800896A8 AC80FFFC */ sw	$zero, -0X4($a0)
.L_800896AC:
/* 009619 0x800896AC 18A00005 */ blez	$a1, .L_800896C4
/* 009620 0x800896B0 00000000 */ nop
/* 009621 0x800896B4 00A42821 */ addu	$a1, $a1, $a0
.L_800896B8:
/* 009622 0x800896B8 24840001 */ addiu	$a0, $a0, 1
/* 009623 0x800896BC 1485FFFE */ bne	$a0, $a1, .L_800896B8
